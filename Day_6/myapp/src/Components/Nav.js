...
function Nav() {
  ...
  const handleClose = () => setOpen(false);
    ...
    return (
      ...
      >
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h4" component="h2" sx={{color:'blueviolet',mb:1}}>
            Login
          </Typography>
          ...
          <Button varient='contained' color='secondary' sx={{my:1,width:'100%',p:2}}>Login</Button>
        </Box>
      </Modal>
        </>
    );
